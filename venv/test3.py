...
def mem_enter():
    calc.insert(0, mem_plus())



def make_M_P_button(operation):
    return tk.Button(text=operation, bd=5, font=("Arial", 13), fg="red", command=mem_plus)

make_M_P_button("M+").grid(row=5, column=0, stick="wens", padx=5, pady=5)


def make_M_E_button(operation):
    return tk.Button(text=operation, bd=5, font=("Arial", 13), fg="red", command=mem_enter)

make_M_E_button("ME").grid(row=5, column=1, stick="wens", padx=5, pady=5)
